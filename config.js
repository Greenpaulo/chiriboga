...
var setRegistry = {
  ...
  availableSets: {
    ...
    rebellion: {
      file: "rebellion",
      code: "rwr",
      name: "Rebellion Without Rehearsal",
      hidden: true,
      untested: true,
      idRange: [34066, 34130],
    },
...
var gauntletConfig = {
  ...
  randomCardRequirements: [
    ...
    // Programs - Icebreakers
    {
      quantity: 1,
      cardType: "program",
      matchSubtypes: ["Icebreaker", "Killer"],
      excludeSubtypes: ["AI"],
    },
    {
      quantity: 1,
      cardType: "program",
      matchSubtypes: ["Icebreaker", "Fracter"],
      excludeSubtypes: ["AI"],
    },
    {
      quantity: 1,
      cardType: "program",
      matchSubtypes: ["Icebreaker", "Decoder"],
      excludeSubtypes: ["AI"],
    },
    {
      quantity: 1,
      cardType: "program",
      matchSubtypes: ["Icebreaker"],
      excludeSubtypes: ["AI"],
    },
    ...
    // Programs - Other
    {
      quantity: 1,
      cardType: "program",
      matchSubtypes: ["Trojan"],
      excludeSubtypes: ["Icebreaker"],
    },
    {
      quantity: 4,
      cardType: "program",
